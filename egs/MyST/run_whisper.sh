...
export rootdir=/home/klp65/rds/hpc-work/SPAPL_KidsASR/
...
if [ $stage -le 1 ] && [ $end_stage -ge 1 ]; then
  ...
  models="large" # KL: only training and evaluating whisper small 
  ...
  for model in $models; do
	...
	--results_file "whisperL_baseline_myst-sclite.txt"
...
if [ $stage -le 2 ] && [ $end_stage -ge 2 ]; then
  ...
  exp_dir="exp/PP_adapterFT_21k_lr1e-4_8ksteps/"

  [ ! -d $exp_dir ] && mkdir -p $exp_dir

  train_config=conf/whisper_small_train_PP.yaml # change this configuration file for finetuning method
...
if [ $stage -le 3 ] && [ $end_stage -ge 3 ]; then
  ...
  exp_dir="exp/PP_noCSLU_adapterFT_lr1e-4_8ksteps"
  ...
  for x in test_cslu_scripted; do
    ...
    for checkpoint in $checkpoints; do
      ...
      CUDA_VISIBLE_DEVICES="0" decode_asr.py \
        ...
        --result_hyp_file $resultdir/hyp.txt \
        --chunk_length $chunk_length > $resultdir/decode.log 2>&1 \
	--results_file "whisper_myst-sclite.txt"
